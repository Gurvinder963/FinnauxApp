...
public class MyApplicationActivity extends AppCompatActivity {
    ...
    public String TAG ="My Applications";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ivHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(MyApplicationActivity.this,TabActivity.class);
        ...
        session=new SessionManager(MyApplicationActivity.this);
    ...
    public void callWebServiceREST() {
        ...
        progress = new ProgressDialog(MyApplicationActivity.this);
            ...
            call.enqueue(new Callback<List<ApplicationListResponse>>() {
                ...
                public void onResponse(Call<List<ApplicationListResponse>> call, Response<List<ApplicationListResponse>> response) {
                    ...
                    if(list!=null && list.size()>0) {
                        ...
                        MyApplicationAdapter adpter = new MyApplicationAdapter(MyApplicationActivity.this, list,TAG);
