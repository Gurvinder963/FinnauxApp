...
public class PendingDOCActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ivHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(PendingDOCActivity.this,TabActivity.class);
        ...
        session=new SessionManager(PendingDOCActivity.this);
    ...
    public void callWebServiceREST() {
        ...
        progress = new ProgressDialog(PendingDOCActivity.this);
        ...
        try {
            ...
            Call<List<ApplicationListResponse>> call = api.getLOS_PendingDocApplication(model);
            ...
            call.enqueue(new Callback<List<ApplicationListResponse>>() {
                ...
                public void onResponse(Call<List<ApplicationListResponse>> call, Response<List<ApplicationListResponse>> response) {
                    ...
                    if(list!=null && list.size()>0) {
                        ...
                        MyApplicationAdapter adpter = new MyApplicationAdapter(PendingDOCActivity.this, list,TAG);
