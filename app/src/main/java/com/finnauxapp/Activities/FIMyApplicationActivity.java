...
public class FIMyApplicationActivity extends AppCompatActivity {

    private SessionManager session;
    private LinearLayoutManager linearLayoutManager;
    private RecyclerView recycler_view;
    public String TAG ="My FI Applications";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ivHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(FIMyApplicationActivity.this,TabActivity.class);
        ...
        session=new SessionManager(FIMyApplicationActivity.this);
    ...
    public void callWebServiceREST() {
        ...
        progress = new ProgressDialog(FIMyApplicationActivity.this);
        ...
        try {
            ...
            Call<List<ApplicationListResponse>> call = api.getApplicationListFI(model);
            ...
            call.enqueue(new Callback<List<ApplicationListResponse>>() {
                ...
                public void onResponse(Call<List<ApplicationListResponse>> call, Response<List<ApplicationListResponse>> response) {
                    ...
                    if(list!=null && list.size()>0) {
                        ...
                        MyApplicationAdapter adpter = new MyApplicationAdapter(FIMyApplicationActivity.this, list,TAG);
