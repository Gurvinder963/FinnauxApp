...
public class CustomerFamilyAdapter extends RecyclerView.Adapter {
    private List<CustomerMemberListResponse> homeList;
    private Context context;




    public CustomerFamilyAdapter(Context context, List<CustomerMemberListResponse> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        CustomerMemberListResponse response=homeList.get(position);




        holder.tvName.setText(response.getMemberName()+" ("+response.getMemberReletion()+")");
        holder.tvAge.setText("Age : "+response.getMemberGenderAge());
        holder.tvPhone.setText("Phone : "+response.getMemberContactNumber());
        holder.tvJob.setText("Job : "+response.getMemberOccupationType());
        holder.tvIncome.setText("Income : "+response.getMemberHowMuchEarn());
        ...
        holder.ivEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FamilyMemberListActivity activity=((FamilyMemberListActivity)context);
